...
describe('Game3', function () {
  async function deployContractAndSetVariables() {
    ...
    return { game, signer, signer2, signer3, address, address2, address3 };
  }

  it('should be a winner', async function () {
    const { game, signer, signer2, signer3, address, address2, address3 } = await loadFixture(deployContractAndSetVariables);
