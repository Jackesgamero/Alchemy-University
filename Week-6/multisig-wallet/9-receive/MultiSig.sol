...
contract MultiSig {
    ...
    function addTransaction(address _recipent, uint256 _value) internal returns(uint256 id){
        id = tx_count;
    ...
    function submitTransaction(address _recipent, uint256 _value) external{
        uint256 txId = addTransaction(_recipent,_value);
